            ...
            <div class="header-content">
               ...
               <nav class="site-nav">
                  <ul class="clean-list site-links">
                     ...
                     <li>
                        <a href="contacto3.php">CONTACT</a>
                     </li>
                     <li>
                        <a href="QueEs3.php">WHATS</a>
                     </li>
                     <li>
                        <a href="administrador.php">DASBOARD</a>
                     </li>

                     <li>  
                   <a href="index.php" class="btn btn-outlined" onclick="exit()">LOGOUT</a>
                   </li>
                  </ul>
